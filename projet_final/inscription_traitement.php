...
        <h1>L'inscription traitement</h1>
                        <?php
                                ...
                                }else{$quer="SELECT id, nom FROM Clinique.Veterinaire"; } 
                                ...
                                if($noticia2['id']==@$animal_id){echo "<option selected value='$noticia2[id]'>$noticia2[nom]</option>"."<BR>";}
                                else{echo  "<option value='$noticia2[id]'>$noticia2[nom]</option>";}
                                }
                                echo "</select>";
